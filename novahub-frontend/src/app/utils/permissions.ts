...
const VIEW_PERMISSION_ACTIONS: Record<string, readonly PermissionMatrixAction[]> = {
  ...
  RESTAURANT_TABLES: ['read', 'create', 'approve', 'export'],
  RESTAURANT_SALON: ['read', 'create', 'edit', 'approve', 'export'],
  RESTAURANT_ORDERS: ['read', 'create', 'edit', 'approve', 'export'],
  RESTAURANT_MENU: ['read', 'create', 'edit', 'export'],
  RESTAURANT_KITCHEN: ['read', 'approve', 'export'],
  RESTAURANT_REPORTS: ['read', 'export'],
  ...
  TRACKING_TRANSIT: ['read', 'create', 'edit', 'delete', 'export'],
  TRACKING_RECEPTION: ['read', 'create', 'approve', 'export'],
  TRACKING_BATCHES: ['read', 'create', 'edit', 'delete', 'approve', 'export'],
  TRACKING_PACKAGES: ['read', 'create', 'export'],
  TRACKING_RECONCILIATION: ['read', 'approve', 'export'],
  ...
  INVENTORY_WAREHOUSES: ['read', 'create', 'edit', 'delete', 'export'],
  INVENTORY_TRANSFERS: ['read', 'create', 'edit', 'export'],
  INVENTORY_ADJUSTMENTS: ['read', 'create', 'approve', 'export', 'viewCost'],
  INVENTORY_MOVEMENTS: ['read', 'create', 'export', 'viewCost'],
  INVENTORY_AUDITS: ['read', 'create', 'delete', 'approve', 'export'],
  INVENTORY_LOSSES: ['read', 'export', 'viewCost'],
  INVENTORY_ASSETS: ['read', 'create', 'edit', 'delete', 'import', 'export', 'viewCost'],
  INVENTORY_CONFIG: ['read', 'edit'],

  FINANCIAL_DASHBOARD: ['read', 'export'],
  FINANCIAL_BANK: ['read', 'export'],
  FINANCIAL_RECEIVABLES: ['read', 'export'],
  FINANCIAL_PAYABLES: ['read', 'export'],
  ...
  FINANCIAL_CALENDAR: ['read', 'export'],
  ...
  HR_DASHBOARD: ['read', 'export'],
  HR_EMPLOYEES: ['read', 'create', 'edit', 'delete', 'import', 'export', 'approve'],
  HR_DEPARTMENTS: ['read', 'create', 'edit', 'delete', 'export'],
  HR_PAYROLL: ['read', 'create', 'edit', 'delete', 'import', 'export', 'approve'],
  HR_COMMISSIONS: ['read', 'export'],
  HR_COMMISSIONS_CONFIG: ['read', 'edit'],
  HR_ATTENDANCE: ['read', 'create', 'import', 'export'],
  HR_LEAVES: ['read', 'create', 'edit', 'delete', 'approve', 'export'],
  HR_PERFORMANCE: ['read', 'create', 'edit', 'export'],
  HR_BENEFITS: ['read', 'create', 'edit', 'delete', 'approve', 'export'],
  HR_PAYROLL_CONFIG: ['read', 'create', 'edit'],

  ACTIVITIES_TASKS: ['read', 'create', 'edit', 'delete', 'approve', 'export'],
  ACTIVITIES_EVENTS: ['read', 'create', 'edit', 'delete', 'approve', 'export'],
  ACTIVITIES_REMINDERS: ['read', 'create', 'edit', 'delete', 'export'],
  ACTIVITIES_LOGS: ['read', 'create', 'edit', 'delete', 'export'],
  ACTIVITIES_CALENDAR: ['read', 'create', 'edit', 'delete', 'export'],
  ACTIVITIES_MEETINGS: ['read', 'create', 'edit', 'delete', 'approve', 'export'],
  ...
  TICKETS_LIST: ['read', 'create', 'edit', 'delete', 'approve', 'export'],
  TICKETS_VIEW: ['read', 'create', 'edit', 'delete', 'approve', 'export'],
  ...
  FINANCING_APPLICATIONS: ['read', 'create', 'edit', 'approve', 'export'],
  ...
  ACCOUNTING_HR_PAYMENT_REQUESTS: ['read', 'delete', 'approve', 'export'],
  ACCOUNTING_LEDGER: ['read', 'export'],
  ACCOUNTING_TRIAL_BALANCE: ['read', 'export'],
  ACCOUNTING_PROFIT_LOSS: ['read', 'export'],
  ACCOUNTING_BALANCE_SHEET: ['read', 'export'],
  ACCOUNTING_CASH_FLOW: ['read', 'export'],
  ACCOUNTING_EXCHANGE_DIFFERENCES: ['read', 'create', 'approve', 'export'],
  ACCOUNTING_EQUITY: ['read', 'export'],
  ACCOUNTING_ASSETS: ['read', 'create', 'edit', 'delete', 'import', 'approve', 'export'],
  ACCOUNTING_RECONCILIATION: ['read', 'create', 'edit', 'approve', 'export'],
  ...
  ACCOUNTING_BUDGET: ['read', 'create', 'edit', 'delete', 'export'],
