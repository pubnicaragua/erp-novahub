              ...
              <>
                ...
                <div className="border-t border-[#d1fae5] p-3">
                  <div className="flex gap-2">
                    <input type="text" placeholder="Escribe tu mensaje..." value={input} onChange={(e) => setInput(e.target.value)} onKeyPress={handleKeyPress} className="flex-1 rounded-xl border border-[#d1fae5] px-4 py-2.5 text-sm text-[#174a3a] placeholder-[#84a1ad] outline-none transition-all focus:border-[#22c55e]" />
