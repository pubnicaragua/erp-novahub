      ...
      <Card className="overflow-hidden rounded-3xl border-border/60 shadow-sm">
        <CardHeader className="bg-gradient-to-br from-primary/10 via-card to-card">
          <div className="flex min-w-0 flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            ...
            <Badge variant="outline" className="w-fit shrink-0 rounded-md border-primary/20 bg-primary/5 text-primary">Configuración por sucursal</Badge>
          </div>
        </CardHeader>
        <CardContent className="space-y-5 p-4 sm:p-6">
          ...
          {selectedBranch && <div className="space-y-4">
            <div className="flex min-w-0 flex-wrap items-center justify-between gap-2 rounded-2xl border border-border/60 bg-muted/20 px-4 py-3"><div className="flex min-w-0 items-center gap-2"><Building2 className="size-4 shrink-0 text-primary" /><span className="truncate font-black">{selectedBranch.name}</span></div><Badge variant="outline" className="shrink-0 rounded-md">{selectedBranch.items.length} configuración(es)</Badge></div>
