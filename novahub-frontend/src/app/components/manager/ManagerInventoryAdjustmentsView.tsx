...
export function ManagerInventoryAdjustmentsView({ groupId, businessUnitId, branchId, branches: _branches, warehouses, embedded = false, refreshKey = 0 }: {
  groupId: string;
