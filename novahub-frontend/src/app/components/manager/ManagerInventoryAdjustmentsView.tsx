    ...
    <div className="min-w-0 space-y-5">
      {!embedded && <div className="flex min-w-0 flex-col gap-2 md:flex-row md:items-end md:justify-between">
        <div className="min-w-0">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Consulta los ajustes de las sucursales incluidas en el rubro seleccionado. Esta vista no modifica existencias.</p>
        </div>
