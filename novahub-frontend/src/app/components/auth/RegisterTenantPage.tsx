...
/** El registro debe usar el mismo catálogo canónico que Roles y el sidebar. */
const PARENT_SUBMODULES: Record<string, string[]> = SIDEBAR_PERMISSION_PARENT_ORDER.reduce((catalog, parent) => {
  catalog[parent] = SIDEBAR_PERMISSION_SUBMODULES
    .filter((module) => module.parent === parent && module.subscription !== false)
...
const SUBMODULE_NAMES_ES: Record<string, string> = {
  ...
  SALES_PRICE_LISTS: 'Listas de precios',
  RETAIL_POS: 'Facturación por caja',
  RETAIL_CASH_CONTROL: 'Control de Caja',
  ...
  PURCHASES_RETURNS: 'Créditos del proveedor',
  PURCHASES_PAYMENTS: 'Pagos Emitidos',
  INVENTORY_PRODUCTS: 'Productos',
  INVENTORY_SERVICES: 'Servicios',
  INVENTORY_ATTRIBUTES: 'Atributos y categorías',
  ...
  INVENTORY_AUDITS: 'Auditorías',
  INVENTORY_LOSSES: 'Pérdidas',
  INVENTORY_ASSETS: 'Mobiliario y equipos',
  INVENTORY_CONFIG: 'Configuración de inventario',
  ...
  FINANCIAL_RECEIVABLES: 'Cuentas por Cobrar',
  FINANCIAL_PAYABLES: 'Cuentas por Pagar',
  FINANCIAL_CALENDAR: 'Calendario Financiero',
  FINANCIAL_ANALYSIS: 'Análisis de ingresos y gastos',
  FINANCIAL_LOSSES: 'Pérdidas',
  ...
  DOCUMENTS_STORAGE_PLANS: 'Planes de almacenamiento',
  ...
  CONFIG_PDF: 'Documentos PDF',
  CONFIG_ROLES: 'Roles',
  CONFIG_DEPARTMENTS: 'Departamentos',
  ...
  ACCOUNTING_EXCHANGE_DIFFERENCES: 'Diferencias Cambiarias',
  ACCOUNTING_EQUITY: 'Cambios Patrimonio',
  ACCOUNTING_ASSETS: 'Activos Fijos',
  ACCOUNTING_RECONCILIATION: 'Conciliación Bancaria',
  ACCOUNTING_PERIODS: 'Períodos Contables',
  ACCOUNTING_FISCAL: 'Reportes Fiscales',
  ACCOUNTING_INVOICE_AUDIT: 'Auditoría de Facturas',
  ACCOUNTING_BUDGET: 'Presupuestos',
  ACCOUNTING_EXPENSE_CATEGORIES: 'Categorías Gastos',
  ACCOUNTING_CONFIG: 'Configuración',
  RESTAURANT_SALON: 'Salón y mesas',
  RESTAURANT_ORDERS: 'Comandas',
  RESTAURANT_KITCHEN: 'Cocina',
  RESTAURANT_MENU: 'Carta',
  RESTAURANT_REPORTS: 'Reportes restaurante',
  TRACKING_TRANSIT: 'En tránsito',
  TRACKING_RECEPTION: 'Recepción de paquetes',
  TRACKING_BATCHES: 'Recepción en lote',
  TRACKING_PACKAGES: 'Paquetes recibidos',
  TRACKING_RECONCILIATION: 'Conciliación de compras',
  TRACKING_BILLING: 'Disponibles para facturar',
  TRACKING_CONFIG: 'Configuración de tracking',
};
...
const VISIBLE_PARENT_KEYS = [
  ...SIDEBAR_PERMISSION_PARENT_ORDER.filter((parent) => !['DASHBOARD', 'MY_COMPANY', 'CONFIGURATION'].includes(parent)),
];
