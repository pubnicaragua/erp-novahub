          ...
          <Card className="overflow-hidden">
            <CardHeader className="py-3 px-4">
              <div className="flex items-center justify-between">
                ...
                {viewJournal && (
                  <Button type="button" variant="ghost" size="icon" className="size-7 text-muted-foreground hover:bg-muted hover:text-foreground" onClick={() => setViewJournalId(null)} aria-label="Cerrar detalle del asiento" title="Cerrar">
            ...
            <CardContent className="space-y-4">
              ...
              {importRows.length > 0 && (
                <>
                  ...
                  <div data-import-preview-horizontal-scroller="true" className="hidden min-w-0 max-w-full overflow-x-auto overflow-y-hidden rounded-xl border border-border/60 scrollbar-overlay sm:block">
