...
import { createDefaultTemplateDefinition, createPdfTemplateSampleData, createSystemDefaultPdfSettings, definitionFromExtractedPdf, sanitizeTemplateDefinition, type PdfTemplateDefinition, type PdfTemplateNode } from '../../services/pdf-template-definition';
...
export function PdfDocumentCustomizer({ tenantId, branchName = '', companyName = '', corporateColor = '#10b981', logo, canEdit = true, canCreate = true, canDelete = true }: { tenantId?: string; branchName?: string; companyName?: string; corporateColor?: string; logo?: string | null; canEdit?: boolean; canCreate?: boolean; canDelete?: boolean }) {
  ...
  const canvasLogo = templateLogoSource && resolvedTemplateLogo.source === templateLogoSource
    ...
    : logo;
  const canvasSampleData = createPdfTemplateSampleData(previewDocument);
