...
export function Topbar({ onMenuClick, onNavigate, isCollapsed, onToggleCollapse }: TopbarProps) {
  ...
  const SEARCH_CATALOG = [
    ...
    { label: 'Productos', description: 'Catálogo de productos y servicios', module: 'inventario', subModule: 'productos', keywords: ['producto', 'articulo', 'servicio', 'sku'], group: 'Inventario de Mercancías' },
    { label: 'Categorías', description: 'Categorías de productos', module: 'inventario', subModule: 'categorias', keywords: ['categoria', 'tipo'], group: 'Inventario de Mercancías' },
    { label: 'Movimientos', description: 'Entradas y salidas de inventario', module: 'inventario', subModule: 'movimientos', keywords: ['movimiento', 'entrada', 'salida'], group: 'Inventario de Mercancías' },
    { label: 'Ajustes de Stock', description: 'Ajustes manuales de inventario', module: 'inventario', subModule: 'ajustes', keywords: ['ajuste', 'stock'], group: 'Inventario de Mercancías' },
    { label: 'Transferencias', description: 'Movimientos entre almacenes', module: 'inventario', subModule: 'transferencias', keywords: ['transferencia', 'almacen'], group: 'Inventario de Mercancías' },
    { label: 'Mobiliario y Equipos', description: 'Activos de la empresa (edificios, vehículos, equipos)', module: 'inventario', subModule: 'mobiliario-equipos', keywords: ['mobiliario', 'activo', 'edificio', 'vehiculo', 'equipo', 'maquinaria'], group: 'Inventario de Mercancías' },
