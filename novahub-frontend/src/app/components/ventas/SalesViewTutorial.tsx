...
const TUTORIALS: Record<SalesTutorialView, SalesTutorial> = {
  ...
  recurring: { title: 'Facturas Recurrentes', listLabel: 'Cómo programar facturas recurrentes', description: 'Administra los contratos y servicios que generan facturación periódica para tus clientes.', kpis: 'MRR y ARR son indicadores de ingreso recurrente. Activas es un filtro; Próximas 7 días te ayuda a planificar emisiones sin modificar la lista.', filters: 'Busca por cliente, concepto o contrato y revisa las fechas configuradas. Usa el filtro Activas para separar contratos vigentes de pausados.', actions: 'Desde cada fila puedes pausar o reanudar, descargar el PDF, ver el detalle o cancelar la programación. Las facturas ya generadas se conservan.', pagination: 'Usa el selector de cantidad para definir cuántos contratos se muestran y los controles para avanzar sin perder el filtro actual.', tip: 'Revisa la configuración de periodicidad y los conceptos antes de guardar el documento.', form: { label: 'Cómo programar facturas recurrentes', description: 'Configura un servicio periódico para que el ERP pueda generar sus facturas conforme al calendario definido.', data: 'Selecciona cliente, concepto, moneda, fecha inicial y próxima emisión.', items: 'Agrega los productos o servicios que forman parte del contrato recurrente y valida sus precios.', summary: 'Confirma periodicidad, vigencia, impuestos y el importe esperado de cada emisión.', actions: 'Guarda la configuración y revisa su estado en el listado para pausarla o reanudarla cuando sea necesario.', tip: 'Mantén actualizados el concepto y la periodicidad para evitar emisiones incorrectas.', steps: ['title', 'data', 'items', 'summary', 'actions'] } },
