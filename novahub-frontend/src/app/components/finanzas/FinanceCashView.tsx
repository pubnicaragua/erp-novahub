    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <Card className="rounded-2xl border-border/40 bg-card shadow-sm">
          ...
          <CardContent className="px-2 pb-3">
            <ResponsiveContainer width="100%" height={280}>
              <ComposedChart data={balanceHistory} margin={{ top: 8, right: 16, left: -4, bottom: 0 }}>
                ...
                <YAxis tick={AXIS_TICK} tickLine={false} axisLine={false} tickFormatter={(v: number) => sym + (v / 1000).toFixed(0) + 'K'} width={52} />
        ...
        <Card className="rounded-2xl border-border/40 bg-card shadow-sm">
          ...
          <CardContent className="px-2 pb-3">
            <ResponsiveContainer width="100%" height={280}>
              <BarChart data={distribution} layout="vertical" margin={{ top: 8, right: 16, left: 0, bottom: 0 }}>
                ...
                <YAxis dataKey="name" type="category" tick={{ ...AXIS_TICK, fill: 'hsl(var(--foreground))', fontWeight: 500 }} width={100} />
