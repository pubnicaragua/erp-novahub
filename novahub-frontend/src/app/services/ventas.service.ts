...
export const customersService = {
  ...
  update: (id: string, data: Partial<Customer>) => api.put<Customer>(`/sales/customers/${id}`, data),
...
export const estimatesService = {
  ...
  update: (id: string, data: Partial<Estimate>) => api.put<Estimate>(`/sales/estimates/${id}`, data),
...
export const salesOrdersService = {
  ...
  update: (id: string, data: Partial<SalesOrder>) => api.put<SalesOrder>(`/sales/orders/${id}`, data),
...
export const invoicesService = {
  ...
  update: (id: string, data: Partial<Invoice>) => api.put<Invoice>(`/sales/invoices/${id}`, data),
...
export const recurringInvoicesService = {
  ...
  update: (id: string, data: Partial<RecurringInvoice>) => api.put<RecurringInvoice>(`/sales/recurring-invoices/${id}`, data),
...
export const paymentsService = {
  ...
  update: (id: string, data: Partial<PaymentReceived>) => api.put<PaymentReceived>(`/sales/payments/${id}`, data),
