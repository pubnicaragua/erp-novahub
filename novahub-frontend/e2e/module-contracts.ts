...
export const E2E_MODULE_CONTRACTS: readonly E2eModuleContract[] = [
  ...
  { moduleId: 'auditoria', sourceController: 'audit/audit.controller.ts', apiProbe: { method: 'GET', path: '/audit/logs' }, scope: 'tenant', persistenceModels: ['SystemAuditLog'], invariants: ['tenant', 'branch-scope', 'immutable', 'redaction', 'correlation'], scenarios: BASE_SCENARIOS },
